...
def emd_approx(sample, ref):
    """
    Approximates the Earth Mover's Distance (EMD) between two point clouds using Sinkhorn divergence.
    
    Args:
        sample (torch.Tensor): Batch of sample point clouds, shape [batch_size, num_points, 3].
        ref (torch.Tensor): Batch of reference point clouds, shape [batch_size, num_points, 3].
    
    Returns:
        torch.Tensor: Approximated EMD values, shape [batch_size].
    """
